...
namespace DS.Utilities
{
    ...
    public static class DSIOUtility
    {
        ...
        public static void Initialize(DSGraphView dsGraphView, string graphName)
        {
            ...
            containerFolderPath = $"Assets/Resources/Dialogues/{graphName}";
        ...
        public static void Save()
        {
            ...
            DSGraphSaveDataSO graphData = CreateAsset<DSGraphSaveDataSO>("Assets/_Source/Editor/DialogueSystem/Graphs", $"{graphFileName}Graph");
        ...
        private static void SaveNodeToGraph(DSNode node, DSGraphSaveDataSO graphData)
        {
            ...
            DSNodeSaveData nodeData = new DSNodeSaveData()
            {
                ...
                NextDialogue = node.NextDialogue,
                Position = node.GetPosition().position,
                iconPerson = node.nameandicon.value.ConvertTo<Sprite>(),
                IsInterlocutor = node.InterlocutorToggle.value.ConvertTo<bool>(),
                IsAppear = node.CharacterToggle.value.ConvertTo<bool>()
            };
        ...
        private static void SaveNodeToScriptableObject(DSNode node, DSDialogueContainerSO dialogueContainer)
        {
            ...
            dialogue.Initialize(
                ...
                node.NextDialogue,
                node.IsStartingNode(),
                node.nameandicon.value,
                node.InterlocutorToggle.value,
                node.CharacterToggle.value
            );
        ...
        {
            DSGraphSaveDataSO graphData = LoadAsset<DSGraphSaveDataSO>("Assets/_Source/Editor/DialogueSystem/Graphs", graphFileName);
        ...
        private static void LoadNodes(List<DSNodeSaveData> nodes)
        {
            foreach (DSNodeSaveData nodeData in nodes)
            {
                ...
                node.NextDialogue = nodeData.NextDialogue;
                node.personIcon = nodeData.iconPerson;
                node.IsInterlocutor = nodeData.IsInterlocutor;
                node.IsAppear = nodeData.IsAppear;
                node.Draw();
